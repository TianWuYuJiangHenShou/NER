...
#         print('ins_num:',ins_num,'tag_size:', tag_size)
#         print('self.transitions:',self.transitions.shape)
        
        feats = feats.transpose(1, 0).contiguous().view(
            ins_num, 1, tag_size).expand(ins_num, tag_size, tag_size)
        
        
        test = self.transitions.view(1, tag_size, tag_size)
...
#         print('tags shape',tags.shape)
        ...
        tg_energy = torch.gather(scores.view(seq_len, batch_size, -1), 2, new_tags).view(
            seq_len, batch_size)
#         print(mask.shape,mask.transpose(1, 0).shape,tg_energy.shape)
#         print('%%%'*10)
#         print(mask.transpose(1, 0))
