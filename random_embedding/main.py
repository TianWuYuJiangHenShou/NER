...
parser.add_argument('--trainset', type=str, default=os.path.join('data', 'train_1.csv'), metavar='TRAINSET',
                    help='trainset path')
parser.add_argument('--testset', type=str, default=os.path.join('data', 'test_1.csv'), metavar='TESTSET',
                    help='testset path')
